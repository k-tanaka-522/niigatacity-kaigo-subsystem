...
# ==============================================================================
# CloudFormation Cognito Stack Deployment (Staging)
# ==============================================================================
...
TEMPLATE_DIR="${SCRIPT_DIR}/../production/07_cognito"
...
echo "===================================="
echo "Cognito Stack Deployment (Staging)"
echo "===================================="
...
create_change_set "${DYNAMODB_STACK_NAME}" "${TEMPLATE_DIR}/cognito-dynamodb-tables.yaml" "use-params"
...
aws cloudformation create-change-set \
    ...
    --template-body "file://${TEMPLATE_DIR}/cognito-lambda-triggers.yaml" \
...
aws cloudformation create-change-set \
    ...
    --template-body "file://${TEMPLATE_DIR}/cognito-user-pool.yaml" \
...
aws cloudformation create-change-set \
    ...
    --template-body "file://${TEMPLATE_DIR}/cognito-identity-pool.yaml" \
...
# ==============================================================================
echo "===================================="
echo "✅ All Cognito Stacks Deployed (Staging)"
echo "===================================="
echo ""
echo "Next Steps:"
